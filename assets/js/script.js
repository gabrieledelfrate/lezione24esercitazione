      ...
      <div class="col-md-3 mb-4">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <button class="btn btn-dark btn-sm mb-2 remove-book" data-id="${book.asin}">Scarta</button>
            <button class="btn btn-warning btn-sm mb-2 add-to-cart" data-id="${book.asin}">Aggiungi al carrello</button>
          </div>
        </div>
      </div>
    `;
...
function displayCart() {
    ...
    cartItems.forEach(item => {
      ...
      removeButton.classList.add('btn', 'btn-dark', 'btn-sm', 'mb-2', 'remove-from-cart');
